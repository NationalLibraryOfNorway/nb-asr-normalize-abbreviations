...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Maks. Haug var her.", "Maks. Haug var her."),
        ("Mao sa at...", "Mao sa at..."),
        ("Uncertain Ang", "Uncertain Ang"),
        ("malformed ev", "malformed ev"),
        ("Aaret var 1492.", "Aaret var 1492."),
        ("i 1200-tallet", "i 1200-tallet"),
        ("sports time 3.56", "sports time 3.56"),
        ("version 2.0", "version 2.0"),
        ("opening time 7.30", "opening time 7.30"),
        ("already normalized 1 600", "already normalized 1 600"),
        ("malformed date 29.2015", "malformed date 29.2015"),
